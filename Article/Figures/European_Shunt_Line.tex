...
\begin{tikzpicture}[%
  ...
  %\ctikzset{bipoles/thickness=4,default/thickness=4}
  ...
  to[short, -*] (zln)%
  to[R,l=$R_{\nrm}$, \circuitikzbasekey/bipoles/length=1.2cm] ($(zln)!0.5!(xrn)$)%
  to[L,l=$L_{\nrm}$, \circuitikzbasekey/bipoles/length=1.2cm] (xrn)%
  to[short,-] (xrin)%
  to[short,-*] (zmn)%
  to[short,*-] (xmin)%
  ...
  to[short, -*] (zlc)%
  to[R,l=$R_{\crm}$, \circuitikzbasekey/bipoles/length=1.2cm] ($(zlc)!0.5!(xrc)$)%
  to[L,l=$L_{\crm}$, \circuitikzbasekey/bipoles/length=1.2cm] (xrc)%
  to[short,-] (xric)%
  to[short,-*] (zmc)%
  to[short,*-] (xmic)%
  ...
  to[short, -*] (zlb)%
  to[R,l=$R_{\brm}$, \circuitikzbasekey/bipoles/length=1.2cm] ($(zlb)!0.5!(xrb)$) %
  to[L,l=$L_{\brm}$, \circuitikzbasekey/bipoles/length=1.2cm] (xrb)%
  to[short,-] (xrib)%
  to[short,-*] (zmb)%
  to[short,*-] (xmib)%
  ...
  to[short, -*] (zla)%
  to[R, l=$R_{\arm}$, \circuitikzbasekey/bipoles/length=1.2cm] ($(zla)!0.5!(xra)$)%
  to[L, l=$L_{\arm}$, \circuitikzbasekey/bipoles/length=1.2cm] (xra)%
  to[short,-] (xria)%
  to[short,-*] (zma)%
  to[short,*-] (xmia)%
